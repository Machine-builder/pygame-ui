...
window.style.border_colour = (255,255,255)
window.style.border_thickness = 2
...
container_1.style.border_colour = (0,0,0)
...
container_2.style.border_colour = (0,0,0)
...
container_3.style.border_colour = (0,0,0)
...
for i in range(5):
    ...
    list_widget.style.border_thickness = 2
